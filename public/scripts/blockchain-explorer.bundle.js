...
angular.module('blockchainWalletApp').controller('accountCtrl', __webpack_require__(9));
...
angular.module('blockchainWalletApp').service('validationService', __webpack_require__(19));
angular.module('blockchainWalletApp').service('signupService', __webpack_require__(18));
angular.module('blockchainWalletApp').service('signinService', __webpack_require__(17));
angular.module('blockchainWalletApp').service('mainService', __webpack_require__(16));
angular.module('blockchainWalletApp').service('blockService', __webpack_require__(15));
angular.module('blockchainWalletApp').service('accountService', __webpack_require__(14));
